			...
			<div class="feature-section three-col">
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo esc_html_e("View Documentation", "gutenshop"); ?></h3>
						<p><?php echo esc_html_e("Getting started with a new theme can be difficult, if you have issues then please view our docs.", "gutenshop"); ?></p>
						<p><a target="blank" href="<?php echo esc_url('https://superbthemes.com/gutenshop/gutenshop-documentation/', 'gutenshop'); ?>" class="button button-primary">
							<?php echo esc_html_e("Read Documentation", "gutenshop"); ?>
						</a></p>
					</div>
				</div>
				<div class="col">
